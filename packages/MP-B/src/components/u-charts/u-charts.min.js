...
let assign = function (e, ...t) {
  function i(e, t) {
    for (let a in t)
      e[a] =
        e[a] && '[object Object]' === e[a].toString()
          ? i(e[a], t[a])
          : (e[a] = t[a])
    return e
  }
...
function calRotateTranslate(e, t, i) {
  ...
  return {
    transX: n,
    transY:
      (i - o) * (1.4142135623730951 - 1) - (i - o - a) / 1.4142135623730951,
  }
}
function createCurveControlPoints(e, t) {
  function i(e, t) {
    return (
      !!(e[t - 1] && e[t + 1]) &&
      (e[t].y >= l(e[t - 1].y, e[t + 1].y) ||
        e[t].y <= n(e[t - 1].y, e[t + 1].y))
    )
  }
  function o(e, t) {
    return (
      !!(e[t - 1] && e[t + 1]) &&
      (e[t].x >= l(e[t - 1].x, e[t + 1].x) ||
        e[t].x <= n(e[t - 1].x, e[t + 1].x))
    )
  }
  var n = Math.min,
    l = Math.max,
  ...
  if (
    (1 > t
      ? ((s = e[0].x + (e[1].x - e[0].x) * r),
        (d = e[0].y + (e[1].y - e[0].y) * r))
      : ((s = e[t].x + (e[t + 1].x - e[t - 1].x) * r),
        (d = e[t].y + (e[t + 1].y - e[t - 1].y) * r)),
    t > e.length - 3)
  ) {
    var c = e.length - 1
    ;(h = e[c].x - (e[c].x - e[c - 1].x) * a),
      (x = e[c].y - (e[c].y - e[c - 1].y) * a)
  } else
    (h = e[t + 1].x - (e[t + 2].x - e[t].x) * a),
      (x = e[t + 1].y - (e[t + 2].y - e[t].y) * a)
  return (
    i(e, t + 1) && (x = e[t + 1].y),
    i(e, t) && (d = e[t].y),
    o(e, t + 1) && (h = e[t + 1].x),
    ...
    (x >= l(e[t].y, e[t + 1].y) || x <= n(e[t].y, e[t + 1].y)) &&
      (x = e[t + 1].y),
    (s >= l(e[t].x, e[t + 1].x) || s <= n(e[t].x, e[t + 1].x)) && (s = e[t].x),
    (h >= l(e[t].x, e[t + 1].x) || h <= n(e[t].x, e[t + 1].x)) &&
      (h = e[t + 1].x),
        ...
        ? ((o = i.height - t.clientX * i.pixelRatio),
          (e =
            (t.pageY -
              ...
              (i.height / i.pixelRatio / 2) * (i.pixelRatio - 1)) *
            i.pixelRatio))
...
function getSeriesDataItem(e, t) {
  ...
  for (let a, o = 0; o < e.length; o++)
    if (
      ((a = e[o]),
      null !== a.data[t] && 'undefined' != typeof a.data[t] && a.show)
    ) {
      let e = {}
      ;(e.color = a.color),
        (e.type = a.type),
...
function getToolTipData(e, t, a, i) {
  ...
  for (let o, n = 0; n < t.length; n++)
    (o = t[n]), 'undefined' != typeof o[a] && null !== o[a] && l.push(o[a])
  for (let o, n = 0; n < l.length; n++)
    (o = l[n]), (r.x = Math.round(o.x)), (r.y += o.y)
...
function getCandleToolTipData(e, t, a, o, i, n) {
  ...
  var x = [],
    c = { x: 0, y: 0 }
  for (let l, r = 0; r < a.length; r++)
    (l = a[r]), 'undefined' != typeof l[o] && null !== l[o] && x.push(l[o])
...
function findCurrentIndex(e, t, a, i) {
  ...
  let r = []
  if (0 < t.length) {
    for (let e = 1; e < a.chartData.xAxisPoints.length; e++)
      r.push(a.chartData.xAxisPoints[e] - l)
...
function isInExactChartArea(e, t) {
  return (
    e.x <= t.width - t.area[1] + 10 &&
    e.x >= t.area[3] - 10 &&
    e.y >= t.area[0] &&
    e.y <= t.height - t.area[2]
  )
}
...
function findWordChartCurrentIndex(e, t) {
  for (var a, o = -1, n = 0, l = t.length; n < l; n++)
    if (
      ((a = t[n]),
      e.x > a.area[0] && e.x < a.area[2] && e.y > a.area[1] && e.y < a.area[3])
    ) {
      o = n
      break
    }
...
function findPieChartCurrentIndex(e, t) {
  ...
  if (isInExactPieChartArea(e, t.center, t.radius)) {
    ...
    for (var n, l = 0, r = t.series.length; l < r; l++)
      if (
        ((n = t.series[l]),
        isInAngleRange(o, n._start_, n._start_ + 2 * n._proportion_ * Math.PI))
      ) {
        a = l
        break
      }
...
function calLegendData(e, t, i, a) {
  ...
  if ('top' == t.legend.position || 'bottom' == t.legend.position) {
    ...
    if (g.length) {
      ...
      switch (t.legend.float) {
        case 'left':
          ;(l.area.start.x = t.padding[3]),
            (l.area.end.x = t.padding[3] + 2 * r)
          break
        case 'right':
          ;(l.area.start.x = t.width - t.padding[1] - e - 2 * r),
            (l.area.end.x = t.width - t.padding[1])
          break
        default:
          ;(l.area.start.x = (t.width - e) / 2 - r),
            (l.area.end.x = (t.width + e) / 2 + r)
      }
      ;(l.area.width = e + 2 * r),
    ...
    let i = e.length,
      ...
      o = Math.min(n(a / c), i)
    switch (
      ((l.area.height = o * c + 2 * r),
      (l.area.wholeHeight = o * c + 2 * r),
      t.legend.float)
    ) {
      case 'top':
        ;(l.area.start.y = t.padding[0] + s),
          (l.area.end.y = t.padding[0] + s + l.area.height)
        break
      case 'bottom':
        ;(l.area.start.y = t.height - t.padding[2] - s - l.area.height),
          (l.area.end.y = t.height - t.padding[2] - s)
        break
      default:
        ;(l.area.start.y = (t.height - l.area.height) / 2),
          (l.area.end.y = (t.height + l.area.height) / 2)
    }
    ...
    if (((l.points = g), g.length)) {
      for (let e = 0; e < g.length; e++) {
        ...
        for (let e, o = 0; o < i.length; o++)
          (e =
            h +
            x +
            measureText(i[o].name || 'undefined', d) +
            t.legend.itemGap),
            e > a && (a = e)
      ...
      ;(l.area.width = e - t.legend.itemGap + 2 * r),
        (l.area.wholeWidth = l.area.width + r)
    }
  }
  switch (t.legend.position) {
    case 'top':
      ...
      break
    case 'bottom':
      ;(l.area.start.y = t.height - t.padding[2] - l.area.height - s),
        (l.area.end.y = t.height - t.padding[2] - s)
      break
    case 'left':
      ;(l.area.start.x = t.padding[3]),
        (l.area.end.x = t.padding[3] + l.area.width)
      break
    case 'right':
      ;(l.area.start.x = t.width - t.padding[1] - l.area.width),
        (l.area.end.x = t.width - t.padding[1])
  }
...
function calCategoriesData(e, t, i, a) {
  ...
  return (
    !0 == t.xAxis.rotateLabel &&
      ...
      (o.xAxisHeight = 2 * i.xAxisTextPadding + l * Math.sin(o.angle))),
    o
  )
}
function getXAxisTextList(e, t) {
  ...
  if (
    ...
    -1 < n
      ? ('number' == typeof t.xAxis.data[n].min &&
          (s = a(t.xAxis.data[n].min, s)),
        'number' == typeof t.xAxis.data[n].max &&
          (d = o(t.xAxis.data[n].max, d)))
  ...
  for (
    var x = s, c = d, p = [], g = (c - x) / t.xAxis.splitNumber, y = 0;
    y <= t.xAxis.splitNumber;
    y++
  )
    p.push(x + g * y)
  return p
...
function calXAxisData(e, t, i) {
  ...
  var o = a.ranges.map(function (e) {
    return (
      (e = util.toFixed(e, 2)), (e = t.xAxis.format ? t.xAxis.format(+e) : e), e
    )
  })
  ...
  return (
    r + 2 * i.xAxisTextPadding > n &&
      ...
      (a.xAxisHeight = 2 * i.xAxisTextPadding + r * Math.sin(a.angle))),
...
function getPieDataPoints(e, t) {
  var a = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : 1,
    o = 0,
    n = 0
  for (let a, n = 0; n < e.length; n++)
    (a = e[n]), (a.data = null === a.data ? 0 : a.data), (o += a.data)
  for (let n, l = 0; l < e.length; l++)
    (n = e[l]),
      ...
      (n._radius_ = t)
  for (let a, o = 0; o < e.length; o++)
    (a = e[o]), (a._start_ = n), (n += 2 * a._proportion_ * Math.PI)
  return e
}
function getFunnelDataPoints(e, t) {
  ...
  for (let o = 0; o < e.length; o++)
    (e[o].radius = (e[o].data / e[0].data) * t * a),
      (e[o]._proportion_ = e[o].data / e[0].data)
  return e.reverse()
}
function getRoseDataPoints(e, t, a, o) {
  ...
  for (let r, s = 0; s < e.length; s++)
    (r = e[s]),
      ...
      0 === l || 'area' == t
        ? ((r._proportion_ = (r.data / l) * n),
          (r._rose_proportion_ = (1 / e.length) * n))
        : ((r._proportion_ = (r.data / l) * n),
          (r._rose_proportion_ = (r.data / l) * n)),
      (r._radius_ = a + (o - a) * ((r.data - d) / (h - d)))
  for (let n, l = 0; l < e.length; l++)
    (n = e[l]), (n._start_ = r), (r += 2 * n._rose_proportion_ * Math.PI)
  return e
}
...
function getPieTextMaxLength(e) {
  ...
  for (let a = 0; a < e.length; a++) {
    let i = e[a],
      o = i.format
        ? i.format(+i._proportion_.toFixed(2))
        : util.toFixed(100 * i._proportion_) + '%'
...
function getXAxisPoints(e, t) {
  ...
  return (
    ...
    'justify' !== t.xAxis.boundaryGap &&
      (!0 === t.enableScroll ? n.push(l + e.length * o) : n.push(r)),
  ...
  return (
    e.forEach(function (e, l) {
      if (null === e) x.push(null)
        ...
        ;(f *= h),
          (m *= h),
          (p.y = n.height - d(f) - n.area[2]),
          (p.y0 = n.height - d(m) - n.area[2]),
          x.push(p)
      }
    }),
    x
...
function getYAxisTextList(e, t, a, o) {
  ...
  if (
    ...
    -1 < s
      ? ('number' == typeof t.yAxis.data[s].min &&
          (h = l(t.yAxis.data[s].min, h)),
        'number' == typeof t.yAxis.data[s].max &&
          (x = r(t.yAxis.data[s].max, x)))
  ...
  for (
    var p = getDataRange(h, x),
      g = p.minRange,
      y = p.maxRange,
      f = [],
      u = (y - g) / t.yAxis.splitNumber,
      m = 0;
...
function calYAxisData(e, t, a) {
  ...
  if (0 < l) {
    ...
    for (let e, x = 0; x < l; x++) {
      ...
      ;(h[x].width += l + 3 * t.pixelRatio),
        !0 === e.disabled && (h[x].width = 0)
    }
  } else {
    var s = [,],
      d = [,],
      h = [,]
    ;(s[0] = getYAxisTextList(e, t, a, n.type)),
      (h[0] = { position: 'left', width: 0 })
...
function calTooltipYAxisData(e, t, a) {
  ...
  for (let s = 0; s < o.length; s++) {
    let t = o[s].shift(),
      i = o[s].pop(),
      d = t - ((t - i) * (e - l)) / n
    ;(d = a.yAxis.data[s].format ? a.yAxis.data[s].format(+d) : d.toFixed(0)),
      r.push(d + '')
  }
  return r
}
...
function contextRotate(e, t) {
  ...
  !0 === t.rotateLock
    ? !0 !== t._rotate_ &&
      (e.translate(t.height, 0), e.rotate((90 * i) / 180), (t._rotate_ = !0))
...
function drawPointShape(e, t, i, a, o) {
  a.beginPath(),
    ...
    'diamond' === i
      ...
      ? e.forEach(function (e) {
          null !== e &&
            (a.moveTo(e.x + 2.5 * o.pixelRatio, e.y),
            a.arc(e.x, e.y, 3 * o.pixelRatio, 0, 2 * Math.PI, !1))
        })
      : 'rect' === i
      ? e.forEach(function (e) {
          null !== e &&
            (a.moveTo(e.x - 3.5, e.y - 3.5), a.rect(e.x - 3.5, e.y - 3.5, 7, 7))
        })
      : 'triangle' == i &&
        e.forEach(function (e) {
          null !== e &&
...
function drawPointText(e, t, i, a) {
  ...
  e.forEach(function (e, n) {
    if (null !== e) {
      a.beginPath(),
        a.setFontSize(t.textSize || i.fontSize),
        a.setFillStyle(t.textColor || '#666666')
      var l = o[n]
      'object' == typeof o[n] &&
        null !== o[n] &&
        (o[n].constructor == Array ? (l = o[n][1]) : (l = o[n].value))
      var r = t.format ? t.format(l) : l
      a.fillText(
        r + '',
        e.x - measureText(r, t.textSize || i.fontSize) / 2,
        e.y - 4,
      ),
        a.closePath(),
        a.stroke()
...
function drawPieText(e, t, a, o, i, n) {
  var l = Math.cos,
    ...
    g = e.map(function (e) {
      var t = e.format
        ? e.format(+e._proportion_.toFixed(2))
        : util.toFixed(100 * e._proportion_.toFixed(4)) + '%'
...
function drawToolTipSplitLine(e, t, i, a) {
  ...
  if (
    ...
    a.beginPath(),
      a.setFillStyle(
        hexToRgb(
          o.labelBgColor || i.toolTipBackground,
          o.labelBgOpacity || i.toolTipOpacity,
        ),
      ),
  ...
  for (let s, d = 0; d < r.length; d++)
    if (
      ...
      a.setFillStyle(hexToRgb(s.labelBgColor, s.labelBgOpacity)),
        ...
        a.rect(
          n,
          d - 0.5 * t.fontSize - t.toolTipPadding,
          r,
          t.fontSize + 2 * t.toolTipPadding,
        ),
        a.closePath(),
        a.stroke(),
        a.fill(),
  ...
  if (
    ...
    for (let h = 0; h < l.length; h++) {
      ...
      a.beginPath(),
        a.setFillStyle(
          hexToRgb(
            n.labelBgColor || t.toolTipBackground,
            n.labelBgOpacity || t.toolTipOpacity,
          ),
        ),
        ...
        a.rect(
          i,
          y - 0.5 * t.fontSize - t.toolTipPadding,
          c,
          t.fontSize + 2 * t.toolTipPadding,
        ),
        a.closePath(),
        ...
        a.stroke(),
        'left' == r[h].position
          ? (s -= r[h].width + e.yAxis.padding)
          : (d += r[h].width + e.yAxis.padding)
    }
  }
}
...
function drawToolTip(e, t, i, a, o) {
  var n = Math.round,
    l = assign(
      {},
      { showBox: !0, bgColor: '#000000', bgOpacity: 0.7, fontColor: '#FFFFFF' },
      i.extra.tooltip,
    ),
    r = 4 * i.pixelRatio,
    s = 5 * i.pixelRatio,
  ...
  !1 == l.showBox ||
    ...
    o.setFillStyle(
      hexToRgb(
        l.bgColor || a.toolTipBackground,
        l.bgOpacity || a.toolTipOpacity,
      ),
    ),
    h
      ...
      if (null !== e.color) {
        ...
        var n = t.x + d + 2 * a.toolTipPadding,
          l =
            ...
            a.toolTipPadding +
            1
        h && (n = t.x - c - d + 2 * a.toolTipPadding),
          o.fillRect(n, l, r, a.fontSize),
          o.closePath()
      }
    }),
    e.forEach(function (e, i) {
...
function drawColumnDataPoints(e, t, i, a) {
  ...
  return (
    ...
    e.forEach(function (n, c) {
      let p, g, y
      ;(p = [].concat(t.chartData.yAxisData.ranges[n.index])),
        (g = p.pop()),
        (y = p.shift())
      var f = n.data
      switch (s.type) {
        case 'group':
          ...
          for (let e, o = 0; o < u.length; o++)
            if (((e = u[o]), null !== e && o > h && o < x)) {
              a.beginPath(),
                a.setStrokeStyle(e.color || n.color),
                a.setLineWidth(1),
                a.setFillStyle(e.color || n.color)
              var S = e.x - e.width / 2,
        ...
        case 'meter':
          ...
          if (
            (d.push(u),
            (u = fixColumeMeterData(u, r, e.length, c, i, t, s.meter.border)),
            0 == c)
          ) {
            for (let e, o = 0; o < u.length; o++)
              if (((e = u[o]), null !== e && o > h && o < x)) {
                ...
                a.moveTo(S, e.y),
                  ...
                  0 < s.meter.border &&
                    ...
                    a.lineTo(
                      S + 0.5 * s.meter.border,
                      e.y + 0.5 * s.meter.border,
                    ),
                    a.lineTo(
                      S + e.width - 0.5 * s.meter.border,
                      e.y + 0.5 * s.meter.border,
                    ),
    ...
    !1 !== t.dataLabel &&
      ...
      e.forEach(function (n, d) {
        let h, x, c
        ;(h = [].concat(t.chartData.yAxisData.ranges[n.index])),
          (x = h.pop()),
          (c = h.shift())
        var p = n.data
        switch (s.type) {
          case 'group':
            ...
            ;(g = fixColumeData(g, r, e.length, d, i, t)),
...
function drawCandleDataPoints(e, t, a, i, o) {
  ...
  ;(l.color = assign(
    ...
    (l.average = assign(
      {},
      { show: !1, name: [], day: [], color: i.colors },
      l.average,
    )),
    (a.extra.candle = l)
  ...
  return (
    ...
    (l.average.show || t) &&
      t.forEach(function (e) {
        let t, l, r
        ;(t = [].concat(a.chartData.yAxisData.ranges[e.index])),
          (l = t.pop()),
          (r = t.shift())
        var h = e.data,
        ...
        for (let t, a = 0; a < c.length; a++) {
          if (
            ...
            for (let i, a = 0; a < t.length; a++)
              if (
                ((i = t[a]),
                0 == e && i.x > p && (o.moveTo(i.x, i.y), (e = 1)),
                0 < a && i.x > p && i.x < g)
              ) {
...
function drawAreaDataPoints(e, t, i, a) {
  var o = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : 1,
    n = assign(
      {},
      { type: 'straight', opacity: 0.2, addLine: !1, width: 2, gradient: !1 },
      t.extra.area,
    )
  ...
  return (
    ...
    e.forEach(function (e) {
      let l, p, g
      ;(l = [].concat(t.chartData.yAxisData.ranges[e.index])),
        (p = l.pop()),
        (g = l.shift())
      let y = e.data,
      ...
      for (let o, l = 0; l < u.length; l++) {
        if (
          ((o = u[l]),
          a.beginPath(),
          a.setStrokeStyle(hexToRgb(e.color, n.opacity)),
          n.gradient)
        ) {
        ...
        if ((a.closePath(), a.fill(), n.addLine)) {
          ...
          if (
            ...
            a.setLineWidth(n.width * t.pixelRatio),
            1 === o.length)
          )
    ...
    !1 !== t.dataLabel &&
      ...
      e.forEach(function (e) {
        let n, l, d
        ;(n = [].concat(t.chartData.yAxisData.ranges[e.index])),
          (l = n.pop()),
          (d = n.shift())
        var h = e.data,
    ...
    e.forEach(function (e) {
      ...
      a.beginPath(),
        ...
        f.forEach(function (e) {
          if (1 === e.length)
            a.moveTo(e[0].x, e[0].y), a.arc(e[0].x, e[0].y, 1, 0, 2 * Math.PI)
          else {
            ...
            if ('curve' === n.type) {
              for (let o, n = 0; n < e.length; n++)
                if (
                  ((o = e[n]),
                  0 == i && o.x > h && (a.moveTo(o.x, o.y), (i = 1)),
                  0 < n && o.x > h && o.x < x)
                ) {
        ...
        a.setLineDash([]),
        !1 !== t.dataPointShape &&
          drawPointShape(y, e.color, e.pointShape, a, t)
    }),
    !1 !== t.dataLabel &&
      1 === o &&
      e.forEach(function (e) {
  ...
  if (
    ...
    e.forEach(function (e) {
      ...
      if ((d.push(S), 'column' == e.type)) {
        ...
        for (let o, n = 0; n < S.length; n++)
          if (((o = S[n]), null !== o && n > c && n < p)) {
            a.beginPath(),
              a.setStrokeStyle(o.color || e.color),
              a.setLineWidth(1),
              a.setFillStyle(o.color || e.color)
            var A = o.x - o.width / 2,
      ...
      'point' == e.type && (e.addPoint = !0),
        !0 == e.addPoint &&
          'column' !== e.type &&
          drawPointShape(S, e.color, e.pointShape, a, t)
    }),
    !1 !== t.dataLabel && 1 === o)
  ) {
    var h = 0
...
function drawXAxis(e, t, i, a) {
  ...
  if (
    ...
    !0 === t.xAxis.calibration &&
      ...
      l.forEach(function (e, i) {
        0 < i &&
          (a.beginPath(),
          a.moveTo(e - d / 2, x),
          a.lineTo(e - d / 2, x + 3 * t.pixelRatio),
          a.closePath(),
          a.stroke())
      })),
    !0 !== t.xAxis.disableGrid &&
      ...
      a.setLineCap('butt'),
      a.setLineWidth(1 * t.pixelRatio),
      'dash' == t.xAxis.gridType &&
        a.setLineDash([t.xAxis.dashLength, t.xAxis.dashLength]),
      (t.xAxis.gridEval = t.xAxis.gridEval || 1),
      l.forEach(function (e, i) {
        0 == i % t.xAxis.gridEval &&
          (a.beginPath(), a.moveTo(e, x), a.lineTo(e, c), a.stroke())
      }),
      a.setLineDash([])),
    !0 !== t.xAxis.disabled)
  ) {
    ...
    t.xAxis.labelCount &&
      ((n = t.xAxis.itemCount
        ? o((e.length / t.xAxis.itemCount) * t.xAxis.labelCount)
        : t.xAxis.labelCount),
      (n -= 1))
    let r = o(e.length / n),
      s = [],
...
function drawYAxisGrid(e, t, i, a) {
  ...
  let o = t.height - t.area[0] - t.area[2],
    ...
    d = s * (r.length - 1),
    h = []
  for (let o = 0; o < t.yAxis.splitNumber + 1; o++)
    h.push(t.height - t.area[2] - n * o)
  a.save(),
    t._scrollDistance_ &&
      0 !== t._scrollDistance_ &&
      a.translate(t._scrollDistance_, 0),
    'dash' == t.yAxis.gridType &&
      a.setLineDash([t.yAxis.dashLength, t.yAxis.dashLength]),
...
function drawYAxis(e, t, a, o) {
  ...
  for (let n, l = 0; l < t.yAxis.data.length; l++)
    if (((n = t.yAxis.data[l]), !0 !== n.disabled)) {
          ...
          o.beginPath(),
            ...
            'left' == r.position
              ? (o.fillText(e + '', x - r.width, l + i / 2),
                !0 == n.calibration &&
                  (o.moveTo(x, l), o.lineTo(x - 3 * t.pixelRatio, l)))
              : (o.fillText(e + '', c + 4 * t.pixelRatio, l + i / 2),
                !0 == n.calibration &&
                  (o.moveTo(c, l), o.lineTo(c + 3 * t.pixelRatio, l))),
            o.closePath(),
            o.stroke()
        }),
        !1 !== n.axisLine &&
      ...
      'left' == r.position
        ? (x -= r.width + t.yAxis.padding)
        : (c += r.width + t.yAxis.padding)
    }
}
  ...
  a.beginPath(),
    ...
    l.forEach(function (e, o) {
      ...
      'top' == t.legend.position || 'bottom' == t.legend.position
        ...
        : ((l = 0 == o ? 0 : n.widthArr[o - 1]),
          (y = r.start.x + s + l),
          (f = r.start.y + s + (r.height - g) / 2)),
        a.setFontSize(i.fontSize)
      for (let n, l = 0; l < e.length; l++) {
        switch (
          ((n = e[l]),
        ...
        a.beginPath(),
          ...
          'top' == t.legend.position || 'bottom' == t.legend.position
            ...
            : ((n.area[2] = y + measureText(n.name, d) + c),
              (y -= h + x),
              (f += p))
      }
    })
...
function drawPieDataPoints(e, t, a, o) {
  ...
  return (
    1 === l && 'ring' === t.type && drawRingTitle(t, a, o, s),
    { center: s, radius: d, series: e }
  )
}
    ...
    e.forEach(function (e, i) {
      t.tooltip &&
        ...
        o.arc(
          ...
          x + e._radius_,
          e._start_,
          e._start_ + 2 * e._rose_proportion_ * n,
        ),
        o.closePath(),
        o.fill()),
        o.beginPath(),
...
function drawArcbarDataPoints(e, t, i, a) {
  ...
  l.radius
    ? (s = l.radius)
    : ((s = Math.min(r.x, r.y)), (s -= 5 * t.pixelRatio), (s -= l.width / 2))
...
function drawGaugeDataPoints(e, t, a, i, o) {
  ...
  if ('progress' == r.type) {
    ...
    for (let e = 0; e < f; e++)
      o.beginPath(),
        u > e / f
          ? o.setStrokeStyle(hexToRgb(t[0].color, 1))
          : o.setStrokeStyle(hexToRgb(t[0].color, 0.3)),
    ...
    o.save(),
      o.translate(s.x, s.y),
      o.rotate((t[0]._proportion_ - 1) * n),
      o.beginPath(),
      o.setLineWidth(r.width / 3)
    ...
    o.restore(),
      o.save(),
      o.translate(s.x, s.y),
      o.rotate((r.startAngle - 1) * n)
    for (
      let e = 0;
      e < r.splitLine.splitNumber * r.splitLine.childNumber + 1;
      e++
    )
      o.beginPath(),
        o.setStrokeStyle(r.splitLine.color),
  ...
  return (
    ...
    1 === l &&
      'gauge' === a.type &&
      ((a.extra.gauge.oldAngle = t[0]._proportion_),
      (a.extra.gauge.oldData = t[0].data)),
...
function drawRadarDataPoints(e, t, a, o) {
  var n = Math.cos,
    ...
    x = Math.min(
      h.x - (getMaxTextListLength(t.categories) + a.radarLabelTextMargin),
      h.y - a.radarLabelTextMargin,
    )
  ;(x -= t.padding[1]),
    o.beginPath(),
    o.setLineWidth(1 * t.pixelRatio),
    ...
    g.forEach(function (e) {
      if (
        ...
        e.data.forEach(function (e, t) {
          0 === t
            ? o.moveTo(e.position.x, e.position.y)
            : o.lineTo(e.position.x, e.position.y)
        }),
        o.closePath(),
        o.fill(),
        !1 !== t.dataPointShape)
...
function drawMapDataPoints(e, t, a, o) {
  ...
  for (var f = 0; f < d.length; f++) {
    o.beginPath(),
      ...
      t.tooltip &&
        t.tooltip.index == f &&
        (o.setStrokeStyle(s.activeBorderColor),
        o.setFillStyle(hexToRgb(s.activeFillColor, s.activeFillOpacity)))
  ...
  ;(t.chartData.mapData = { bounds: h, scale: p, xoffset: g, yoffset: y }),
    drawToolTipBridge(t, a, o, 1),
    o.draw()
}
  ...
  switch (t) {
    ...
    case 'vertical':
      ...
      for (let t = 0; t < a.length; t++) {
        ...
        x ? ((a[t].area = r), (a[t].areav = l)) : (a[t].area = l),
          (a[t].rotate = x)
      }
  }
  return a
...
function drawWordCloudDataPoints(e, t, i, a) {
  ...
  a.beginPath(),
    a.setFillStyle(t.background || '#FFFFFF'),
    a.rect(0, 0, t.width, t.height),
    a.fill(),
    a.save()
...
function drawFunnelDataPoints(e, t, i, a) {
  let o = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : 1,
    ...
    s = n.activeWidth,
    d = Math.min(
      (t.width - t.area[1] - t.area[3]) / 2 - s,
      (t.height - t.area[0] - t.area[2]) / 2 - s,
    )
  ...
  return (
    ...
    !1 !== t.dataLabel &&
      1 === o &&
      drawFunnelText(e, t, a, l, n.labelAlign, s, r),
...
function drawFunnelText(e, t, a, o, n, l, r) {
  ...
  for (let d = 0; d < e.length; d++) {
    let i,
      ...
      p = e[d],
      g = p.format
        ? p.format(+p._proportion_.toFixed(2))
        : util.toFixed(100 * p._proportion_) + '%'
    'right' == n
      ? ((i =
          0 == d
            ? (p.funnelArea[2] + r.x) / 2
            : (p.funnelArea[2] + e[d - 1].funnelArea[2]) / 2),
        (h = i + 2 * l),
      ...
      : ((i =
          0 == d
            ? (p.funnelArea[0] + r.x) / 2
            : (p.funnelArea[0] + e[d - 1].funnelArea[0]) / 2),
        (h = i - 2 * l),
        (x = p.funnelArea[1] + o / 2),
        (c = p.textSize || t.fontSize),
        a.setLineWidth(1 * t.pixelRatio),
  ...
  var t = (function () {
    ...
    a = function (o) {
      if (null === o || !0 === this.isStop)
        return (
          e.onProcess && e.onProcess(1),
          void (e.onAnimationFinish && e.onAnimationFinish())
        )
      if ((null === i && (i = o), o - i < e.duration)) {
        ...
        e.onProcess && e.onProcess(1),
          e.onAnimationFinish && e.onAnimationFinish()
    }
...
function drawCharts(e, t, a, i) {
  ...
  if ('candle' == e) {
    ...
    e.show
      ? ((s = calCandleMA(e.day, e.name, e.color, n[0].data)),
        (s = fillSeries(s, t, a)),
        (t.seriesMA = s))
      : t.seriesMA
  ...
  if (
    ...
    for (let a = 0; a < p.length; a++)
      'left' == p[a].position
        ? ((t.area[3] += 0 < o ? p[a].width + t.yAxis.padding : p[a].width),
          (o += 1))
        : ((t.area[1] += 0 < e ? p[a].width + t.yAxis.padding : p[a].width),
          (e += 1))
  } else a.yAxisWidth = p
  if (((t.chartData.yAxisData = c), t.categories && t.categories.length)) {
    t.chartData.xAxisData = getXAxisPoints(t.categories, t, a)
    let e = calCategoriesData(
        t.categories,
        t,
        a,
        t.chartData.xAxisData.eachSpacing,
      ),
      i = e.xAxisHeight,
      o = e.angle
    ;(a.xAxisHeight = i),
      (a._xAxisTextAngle_ = o),
      (t.area[2] += i),
      (t.chartData.categoriesData = e)
  } else if ('line' === t.type || 'area' === t.type || 'points' === t.type) {
    ;(t.chartData.xAxisData = calXAxisData(n, t, a)),
      (l = t.chartData.xAxisData.rangesFormat)
  ...
  if (
    t.enableScroll &&
    'right' == t.xAxis.scrollAlign &&
    void 0 === t._scrollDistance_
  ) {
    let e = 0,
  ...
  switch (
    ...
    case 'word':
      ...
      ;(!0 == t.updateData || null == t.updateData) &&
        (t.chartData.wordCloudData = getWordCloudPoint(t, d.type)),
      ...
      this.animationInstance = new Animation({
        ...
        onProcess: function (e) {
          ...
          ;(t.chartData.xAxisPoints = r),
            ...
            !1 !== t.enableMarkLine && 1 === e && drawMarkLine(t, a, i),
            s
              ? drawLegend(s, t, a, i, t.chartData)
              : drawLegend(t.series, t, a, i, t.chartData),
...
var Charts = function (e) {
  ...
  if (
    ...
    (t.yAxisTitleWidth =
      !0 !== e.yAxis.disabled && e.yAxis.title ? t.yAxisTitleWidth : 0),
    ('pie' == e.type || 'ring' == e.type) &&
      (t.pieChartLinePadding =
        !1 === e.dataLabel
          ? 0
          : e.extra.pie.labelWidth * e.pixelRatio ||
            t.pieChartLinePadding * e.pixelRatio),
    'rose' == e.type &&
      (t.pieChartLinePadding =
        !1 === e.dataLabel
          ? 0
          : e.extra.rose.labelWidth * e.pixelRatio ||
            t.pieChartLinePadding * e.pixelRatio),
    (t.pieChartTextPadding =
      !1 === e.dataLabel ? 0 : t.pieChartTextPadding * e.pixelRatio),
    (t.yAxisSplit = e.yAxis.splitNumber
      ? e.yAxis.splitNumber
      : config.yAxisSplit),
    (t.rotate = e.rotate),
    e.rotate)
  ...
  ;(t.yAxisWidth = config.yAxisWidth * e.pixelRatio),
    ...
    (this.context = e.context
      ? e.context
      : uni.createCanvasContext(e.canvasId, e.$this)),
    e.canvas2d &&
...
;(Charts.prototype.updateData = function () {
  ...
  (Charts.prototype.getCurrentDataIndex = function (t) {
    var e = null
    if (
      ((e = t.changedTouches ? t.changedTouches[0] : t.mp.changedTouches[0]), e)
    ) {
  ...
  (Charts.prototype.touchLegend = function (t) {
    var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
      i = null
    if (
      ((i = t.changedTouches ? t.changedTouches[0] : t.mp.changedTouches[0]), i)
    ) {
  ...
  (Charts.prototype.scroll = function (t) {
    ...
    if (!(a < Math.floor(1e3 / e))) {
      ...
      var o = null
      if (
        ((o = t.changedTouches ? t.changedTouches[0] : t.mp.changedTouches[0]),
        o && !0 === this.opts.enableScroll)
      ) {
        var n,
        ...
        return (
          drawCharts.call(this, d.type, d, this.config, this.context), r + n
        )
      }
    }
  }),
  (Charts.prototype.scrollEnd = function () {
    if (!0 === this.opts.enableScroll) {
      var e = this.scrollOption,
        t = e.currentOffset,
        i = e.distance
      ;(this.scrollOption.currentOffset = t + i),
