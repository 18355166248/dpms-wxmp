<template>
  <view class="spin">
    ...
    <loading-indicator
      ...
      :animating="true"
      class="spin__img spin__img--nvue"
    ></loading-indicator>
    <!-- #endif -->
    <!-- #ifdef H5 -->
    <svg
      ...
      class="spin__img spin__img--android-H5"
    >
      <circle
        cx="50"
        cy="50"
    ...
    <view
      ...
      "
      :style="{ width: iconSize + 'px', height: iconSize + 'px' }"
      class="spin__img spin__img--android-MP"
    >
      <view
    ...
    <!-- #ifndef APP-NVUE -->
    <view
      v-else-if="!webviewHide"
      :style="{ width: iconSize + 'px', height: iconSize + 'px' }"
      class="spin__img spin__img--ios-H5"
    >
      <image
...
.spin__img--android-MP > view:nth-child(1) {
  animation: loading-android-MP-1 1s 0s linear infinite;
}

.spin__img--android-MP > view:nth-child(2) {
  animation: loading-android-MP-2 1s 0s linear infinite;
}

.spin__img--android-MP > view:nth-child(3) {
