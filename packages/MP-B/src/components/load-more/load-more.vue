<template>
  <view class="load-more" @click="onClick">
    ...
    <loading-indicator
      ...
      :animating="true"
      class="load-more__img load-more__img--nvue"
    ></loading-indicator>
    <!-- #endif -->
    <!-- #ifdef H5 -->
    <svg
      ...
      class="load-more__img load-more__img--android-H5"
    >
      <circle
        cx="50"
        cy="50"
    ...
    <view
      ...
      "
      :style="{ width: iconSize + 'px', height: iconSize + 'px' }"
      class="load-more__img load-more__img--android-MP"
    >
      <view
    ...
    <view
      ...
      :style="{ width: iconSize + 'px', height: iconSize + 'px' }"
      class="load-more__img load-more__img--ios-H5"
    >
      <image
    ...
    <!-- #endif -->
    <text class="load-more__text" :style="{ color: color }">{{
      status === 'more'
...
.load-more__img--ios-H5 {
  position: relative;
  animation: loading-ios-H5 1s 0s step-end infinite;
}

.load-more__img--ios-H5 > image {
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0;
...
.load-more__img--android-MP > view {
  position: absolute;
...
.load-more__img--android-MP > view:nth-child(1) {
  animation: loading-android-MP-1 1s 0s linear infinite;
}

.load-more__img--android-MP > view:nth-child(2) {
  animation: loading-android-MP-2 1s 0s linear infinite;
}

.load-more__img--android-MP > view:nth-child(3) {
