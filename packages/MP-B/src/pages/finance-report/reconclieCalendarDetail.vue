<template>
  <div class="reconclieCalendarDetail-wrapper">
    ...
    <div class="section-title flex-v-center">
      <span class="iconfont icon-time-circle" style="margin-right: 14rpx;" />
      <span>
        当月累计至{{ dataSource.statDate | filterDate('YYYY年MM月DD日') }}
      </span>
    </div>
    <dpmsCell
  ...
  computed: {
    renderList() {
      ...
      return [
        ...
        {
          title: '划扣执行收入',
          value: numberUtils.thousandFormatter(
            dataSource.deductionExecutionAmount,
          ),
        },
      ]
    },
    renderTotalList() {
      ...
      return [
        ...
        },
        {
          title: '普通收费收入',
          value: numberUtils.thousandFormatter(
            dataSource.generalChargeTotalAmount,
          ),
        },
        {
          title: '划扣执行收入',
          value: numberUtils.thousandFormatter(
            dataSource.deductionExecutionTotalAmount,
          ),
        },
      ]
    },
