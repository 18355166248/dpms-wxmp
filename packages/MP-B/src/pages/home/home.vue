<template>
  ...
  >
    ...
    <view class="ph-32">
      ...
      <view class="c-white mt-36 fz-34">你好，牧先生</view>
    </view>
      ...
      <view class="ph-32">
        <view class="statistics pv-32">
          <view class="statistics-header">
            今日统计
            <text class="iconfont icon-eye ml-18"></text>
          </view>
          <view class="statistics-body">
            <view class="statistics-item">
              <text class="statistics-item-header">12</text>
              <text class="statistics-item-body">新增患者</text>
            </view>
            <view class="statistics-item">
              <text class="statistics-item-header">2</text>
              <text class="statistics-item-body">新增预约</text>
            </view>
            <view class="statistics-item">
              <text class="statistics-item-header">13/25</text>
              <text class="statistics-item-body">今日就诊</text>
            </view>
            <view class="statistics-item">
              <text class="statistics-item-header">￥1,000.00</text>
...
console.log('systemInfoObject:', systemInfoObject)
console.log('menuButtonObject:', menuButtonObject)

const navHeight =
  systemInfoObject.statusBarHeight +
  menuButtonObject.height +
  (menuButtonObject.top - systemInfoObject.statusBarHeight)
...
export default {
  ...
  data() {
    return {
      ...
      navHeight: navHeight,
      windowHeight: systemInfoObject.windowHeight,
