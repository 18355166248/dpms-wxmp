    ...
    <div v-for="(detail,index) in detailList">
      ...
      <div class="rows">
        <div class="row">
          ...
          {{timeFormated(detail.visTimeFormated) || ''}} {{detail.medicalInstitutionSimpleCode}}
        </div>
        <div class="row">
        ...
        <div v-if="detail.medicalRecordCheckNormalVOList.length > 0" class="row">
        ...
        <div v-if="detail.medicalRecordTreatmentProgramVOList.length > 0" class="row">
  ...
  export default {
    ...
    methods: {
      getHealthRecordsMedicalRecord(patientId, registerId) {
        ...
        customerAPI.healthRecordsMedicalRecord({ patientId: patientId, registerId:registerId }).then((res) => {
